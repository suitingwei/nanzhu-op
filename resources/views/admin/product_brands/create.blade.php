...
<div class="widget wgreen">
	<div class="widget-head">
		<div class="pull-left">添加商品品牌</div>
	...
	<div class="widget-content">
		...
		<div class="padd">
			<table >
				<tr>
					<td>品牌名称</td><td><input type="text" id="description" placeholder="例如:50ml/瓶或30个/包"/></td>
				</tr>
				<tr>
					<td>品牌介绍</td><td><input type="text" id="introduction" placeholder="商品介绍" /></td>
				</tr>
				<tr>
...
<script>
	...
	function create(){
		...
		if($("#description").val()=="" ||  reg.test($("#sort").val())==false ||$("#introduction").val()==""){
			alert("description不能为空并且，sort只能为数字")
		}
		else{
			var newdescription=$("#description").val();
			var newsort=$("#sort").val();
			var newintro=$("#introduction").val();
			$.ajax({
				type:"post",
				url: thisurl+"/api/malls/brands",
				data:{"title":newdescription,"sort":newsort,"introduction":newintro},
