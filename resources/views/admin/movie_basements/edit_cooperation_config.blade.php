...
@section('content')
    ...
    <div class="widget wgreen">
        ...
        <div class="widget-content">
            <div class="padd">
                <form action="/admin/basement/{{$company->id}}/allow-cooperation" class="form form" method="POST"
                ...
                @if($company->allow_cooperation)
                    <form class="form-horizontal" action="/admin/basements/{{$company->type}}/{{$company->id}}" method="POST"
