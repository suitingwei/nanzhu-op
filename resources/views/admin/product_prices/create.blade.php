...
<div class="widget wgreen">
	...
	<div class="widget-content">
		...
		<div class="padd">
			<form class="pro-form form-horizontal" action="https://apiv2.nanzhuxinyu.com/api/malls/products" method="POST" enctype='multipart/form-data'>
				...
				{{--<div class="form-group">--}}
					...
					{{--<div class="col-lg-8">--}}
						{{--<select name="blood_type" class="form-control">--}}
							...
							{{--<option value="2">面膜</option>--}}
							{{--<option value="3">化妆棉</option>--}}
						{{--</select>--}}
					{{--</div>--}}
				{{--</div>--}}
							...
							<div class="col-lg-4">
								<ul class="pro-option list-unstyled">
									<li>
										<div class="checkbox">
											<label>
												<input type="checkbox" value="">智象美露 双支木盒
											</label>
										</div>
									</li>
									{{--<li>--}}
										{{--<div class="input-group">--}}
											{{--<input class="form-control" type="text" placeholder="采购价">--}}
											{{--<div class="input-group-addon">￥</div>--}}
										{{--</div>--}}
									{{--</li>--}}
									<li>
										<div class="input-group">
											<input class="form-control" type="text" placeholder="销售价">
											<div class="input-group-addon">￥</div>
										</div>
									</li>
								</ul>
		...
		<div class="widget-foot">
			<div class="col-lg-offset-2">
				<button id="saves" type="submit" class="btn btn-lg btn-success btn-submit" onclick="button_disabled()">保存</button>
				&nbsp;&nbsp;&nbsp;&nbsp;
