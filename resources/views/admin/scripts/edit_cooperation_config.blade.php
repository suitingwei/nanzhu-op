...
@section('content')
    ...
    <div class="widget wgreen">
        ...
        <div class="widget-content">
            <div class="padd">
                <form action="/admin/scripts/{{$company->id}}/allow-cooperation" class="form form" method="POST"
                ...
                @if($company->allow_cooperation)
                    <form class="form-horizontal" action="/admin/scripts/{{$company->id}}" method="POST"
