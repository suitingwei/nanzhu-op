...
class PhotographController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        if ($created_at) {
            $basements = MovieBasement::where("created_at", "like", "%" . $created_at . "%")->orderBy("sort",
                "desc")->paginate(20);
            return view("admin.photograph_equip.index", compact("basements"));
        }
        if ($title) {
            $basements = MovieBasement::where("title", "like", "%" . $title . "%")->orderBy("sort",
                "desc")->paginate(20);
            return view("admin.photograph_equip.index", compact("basements"));
        }

        $basements = MovieBasement::where('type','photographEquip')->orderBy("sort", "desc")->paginate(20);
        return view("admin.photograph_equip.index", compact("basements"));
    }
    ...
    public function create(Request $request)
    {
        ...
        return view("admin.photograph_equip.create", compact('user_id'));
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->to("/admin/photograph/")->with("message", "创建成功");
    ...
    public function edit($basementId, Request $request)
    {
        ...
        return view('admin.photograph_equip.edit', compact('basement','picurls'));
    }
    public function update($basementId, Request $request)
    {
        ...
        return redirect()->to("/admin/photograph");
    }
}
