...
class DessertController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        if ($created_at) {
            $basements = MovieBasement::where("created_at", "like", "%" . $created_at . "%")->where("type","dessert")->orderBy("sort",
                "desc")->paginate(20);
            return view("admin.dessert.index", compact("basements"));
        }
        if ($title) {
            $basements = MovieBasement::where("title", "like", "%" . $title . "%")->where("type","dessert")->orderBy("sort",
                "desc")->paginate(20);
            return view("admin.dessert.index", compact("basements"));
        }

        $basements = MovieBasement::where('type','dessert')->orderBy("sort", "desc")->paginate(20);
        return view("admin.dessert.index", compact("basements"));
    }
    ...
    public function create(Request $request)
    {
        ...
        return view("admin.dessert.create", compact('user_id'));
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->to("/admin/dessert/")->with("message", "创建成功");
    ...
    public function edit($basementId, Request $request)
    {
        ...
        return view('admin.dessert.edit', compact('basement','picurls'));
    }
