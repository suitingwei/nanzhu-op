...
class SpecialController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        if ($created_at) {
            $basements = MovieBasement::where("created_at", "like", "%" . $created_at . "%")->where('type','specialEffect')->orderBy("sort",
                "desc")->paginate(20);
            return view("admin.special_effect.index", compact("basements"));
        }
        if ($title) {
            $basements = MovieBasement::where("title", "like", "%" . $title . "%")->where('type','specialEffect')->orderBy("sort",
                "desc")->paginate(20);
            return view("admin.special_effect.index", compact("basements"));
        }

        $basements = MovieBasement::where('type','specialEffect')->orderBy("sort", "desc")->paginate(20);
        return view("admin.special_effect.index", compact("basements"));
    }
    ...
    public function create(Request $request)
    {
        ...
        return view("admin.special_effect.create", compact('user_id'));
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->to("/admin/special/")->with("message", "创建成功");
    ...
    public function edit($basementId, Request $request)
    {
        ...
        return view('admin.special_effect.edit', compact('basement','picurls'));
    }
