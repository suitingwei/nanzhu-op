...
class UniformController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        if ($created_at) {
            $basements = MovieBasement::where("created_at", "like", "%" . $created_at . "%")->where("type","uniform")->orderBy("sort",
                "desc")->paginate(20);
            return view("admin.uniform.index", compact("basements"));
        }
        if ($title) {
            $basements = MovieBasement::where("title", "like", "%" . $title . "%")->where("type","uniform")->orderBy("sort",
                "desc")->paginate(20);
            return view("admin.uniform.index", compact("basements"));
        }

        $basements = MovieBasement::where('type','uniform')->orderBy("sort", "desc")->paginate(20);
        return view("admin.uniform.index", compact("basements"));
    }
    ...
    public function create(Request $request)
    {
        ...
        return view("admin.uniform.create", compact('user_id'));
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->to("/admin/uniform/")->with("message", "创建成功");
    ...
    public function edit($basementId, Request $request)
    {
        ...
        return view('admin.uniform.edit', compact('basement','picurls'));
    }
    public function update($basementId, Request $request)
    {
        ...
        return redirect()->to("/admin/uniform");
    }
}
