...
class LightController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        if ($created_at) {
            $basements = MovieBasement::where("created_at", "like", "%" . $created_at . "%")->where("type","lightEquip")->orderBy("sort",
                "desc")->paginate(20);
            return view("admin.light_equip.index", compact("basements"));
        }
        if ($title) {
            $basements = MovieBasement::where("title", "like", "%" . $title . "%")->where("type","lightEquip")->orderBy("sort",
                "desc")->paginate(20);
            return view("admin.light_equip.index", compact("basements"));
        }

        $basements = MovieBasement::where('type','lightEquip')->orderBy("sort", "desc")->paginate(20);
        return view("admin.light_equip.index", compact("basements"));
    }
    ...
    public function create(Request $request)
    {
        ...
        return view("admin.light_equip.create", compact('user_id'));
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->to("/admin/light/")->with("message", "创建成功");
    ...
    public function edit($basementId, Request $request)
    {
        ...
        return view('admin.light_equip.edit', compact('basement','picurls'));
    }
    public function update($basementId, Request $request)
    {
        ...
        return redirect()->to("/admin/light");
    }
}
